<template>
    <Head>
        <title>Transactions - Juara POS</title>
    </Head>
    <main class="c-main">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-8 text-right">
                                        ...
                                        <div v-if="change > 0">
                                            <hr>
                                            <h5 class="text-success">Kembalian: <strong>Rp. {{formatPrice(change)}} </strong></h5>
                                        </div>
                                    </div>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right fw-bold" style="background-color: #e6e6e7;">Rp. {{ formatPrice(carts_total) }}</td>
                                        </tr>
                                    </tbody>
                                </table>
                                <hr>
        ...
        setup(props) {
            ...
            const storeTransaction = () => {
                ...
                .then(response => {
                    ...
                    // set state customer_id to empty string
                    customer_id.value = '';
